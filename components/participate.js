export default function Participate() {
  ...
  <div style={{marginLeft:"5%", marginRight:"5%", marginBottom:"5%"}}>
    <div style={{fontSize:"300%", textAlign:"center", fontWeight:"bold", color:"#141722", marginBottom:"5%"}}>How to Participate</div>
   <div className="grid md:grid-cols-2 lg:grid-cols-2 sm:grid-cols-1">
    <div className="grid-cols-1 rounded-l-3xl rounded-r-3xl lg:rounded-r-none md:rounded-r-none" style={{padding:"10%", backgroundColor:"#55a", marginBottom:"5%", color:"#ddd"}}>
        ...
        <div style={{fontSize:"110%"}}>Stakers play an important role in the Olympus ecosystem. Stakers deposit their OHM into the protocol, 
            ...
            <button className="px-7 py-2 rounded-full" id="participateButton" style={{marginTop:"5%", border:"2px solid #ddd", fontSize:"110%", transition:"1s ease-in-out"}}>STAKE</button>
    </div>
    ...
    <div className="grid grid-cols-4">
        ...
        <button className="px-7 py-2 rounded-full" id="participateButton" style={{marginTop:"5%", border:"2px solid #222", fontSize:"110%", transition:"1s ease-in-out"}}>BOND</button>
    </div>
   </div>
  </div>
    );
