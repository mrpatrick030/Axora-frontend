...
var displayF1 = "No, OHM is not a stable coin. Our goal is to develop a Web3-native asset that helps users preserve purchasing power, has deep liquidity across the ecosystem, is utilized.";
...
return (
    ...
    <div className="grid-cols-1" style={{fontSize:"300%", fontWeight:"bold", color:"#141722",}}> FAQ </div>
    ...
    <div id="faqRender1" style={{color:"#141722",paddingLeft:"5%", fontSize:"120%",paddingRight:"5%"}}></div>
    ...
    <div id="faqRender2" style={{color:"#141722",paddingLeft:"5%", fontSize:"120%",paddingRight:"5%"}}></div>
    <div style={{borderBottom:"2px solid #d7b679", marginTop:"2%"}}></div>
    </div>
    ...
    <div id="faqRender3" style={{color:"#141722",paddingLeft:"5%",paddingRight:"5%", fontSize:"120%",}}></div>
    <div style={{borderBottom:"2px solid #d7b679", marginTop:"2%"}}></div>
    </div>
